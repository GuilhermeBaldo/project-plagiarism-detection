...
if __name__ == '__main__':
    ...
    parser.add_argument('--input-features', type=int, default=3, metavar='N',
                        help='number of input features (input nodes) for the neural network (default: 3)')
    parser.add_argument('--hidden-dim', type=int, default=10, metavar='N',
                        help='number of neurons in the hidden layer of the neural network (default: 10)')
    parser.add_argument('--output-dim', type=int, default=1, metavar='N',
                        help='number of output nodes of the neural network (default: 1)')
